...
HD void Rprintf(const char *, ...) R_PRINTF_FORMAT(1, 2);
HD void REprintf(const char *, ...) R_PRINTF_FORMAT(1, 2);

#if !defined(__cplusplus) || defined R_USE_C99_IN_CXX

HD void Rvprintf(const char *, R_VA_LIST) R_PRINTF_FORMAT(1, 0);
HD void REvprintf(const char *, R_VA_LIST) R_PRINTF_FORMAT(1, 0);
